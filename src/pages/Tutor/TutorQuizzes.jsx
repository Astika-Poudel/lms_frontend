...
const TutorQuizzes = () => {
    ...
    const fetchAllQuizzes = async () => {
        try {
            ...
            const response = await axios.get(`${LMS_Backend}/api/quiz/all`, {
                        ...
                        {quizzes.map((quiz) => (
                            ...
                            >
                                ...
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="text-gray-500">
                                        Type: {quiz._id.toString() === quiz.course?.beginnerQuiz?.toString() ? "Beginner" : "Advanced"}
                                    </span>
                                </div>
                                <div className="flex justify-between text-sm mt-2">
                                    <span className="text-gray-500">
                                        Questions: {quiz.questionsPool?.length || 0}
                                    </span>
                                    <span className="text-gray-500">
