...
const AddLecture = () => {
    ...
    const [lectureForms, setLectureForms] = useState([
        { title: "", description: "", type: "beginner", file: null }, // Added type with default "beginner"
    ]);
    ...
    const addNewLectureForm = () => {
        setLectureForms([...lectureForms, { title: "", description: "", type: "beginner", file: null }]);
    };
    ...
    const handleSubmit = (e) => {
        ...
        lectureForms.forEach((form, index) => {
            ...
            if (id && isValid) {
                addLecture(id, { title: form.title, description: form.description, type: form.type }, form.file);
            } else if (!id) {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                {lectureForms.map((form, index) => (
                    <div key={index} className="space-y-4 border-b pb-4">
                        ...
                        <div className="form-group">
                            <label htmlFor={`type-${index}`} className="block text-gray-700 font-medium mb-2">
                                Lecture Type
                            </label>
                            <select
                                id={`type-${index}`}
