...
const CourseProgress = () => {
  ...
  const phases = [
    ...
    { name: "Beginner Quiz", enabled: completedBeginnerLectures, icon: <CheckCircle className="w-5 h-5 text-gray-600" /> },
    { 
    ...
    { name: "Advanced Quiz", enabled: completedAdvancedLectures, icon: <CheckCircle className="w-5 h-5 text-gray-600" /> },
    { name: "Certification", enabled: certificateAwarded, icon: <Award className="w-5 h-5 text-gray-600" /> },
  ];
              ...
              {phases.map((phase, index) => (
                <div key={index}>
                  ...
                  >
                    ...
                    {phase.lectures && (expandedPhases.includes(index) ? <ChevronUp className="w-4 h-4 text-gray-600" /> : <ChevronDown className="w-4 h-4 text-gray-600" />)}
                  </div>
              ...
              <div className="flex justify-between items-center mb-4">
                <div className="flex gap-4">
                  <button
                    ...
                    className={`text-base font-medium ${activeNotesTab === "new" ? "text-[#134e4a] border-b-2 border-[#134e4a]" : "text-gray-600"}`}
                  >
                    New Note
                  </button>
                  <button
                    onClick={() => setActiveNotesTab("my")}
                    className={`text-base font-medium ${activeNotesTab === "my" ? "text-[#134e4a] border-b-2 border-[#134e4a]" : "text-gray-600"}`}
                  >
                    My Notes
                  </button>
                </div>
                ...
                <div>
                  <div className="flex gap-2 mb-4">
                    <button
                      ...
                      className={`px-3 py-1 rounded-lg text-sm font-medium ${notesFilter === "section" ? "bg-[#134e4a] text-white" : "bg-gray-200 text-gray-600"}`}
                    >
                      This Section
                    </button>
                    <button
                      onClick={() => setNotesFilter("course")}
                      className={`px-3 py-1 rounded-lg text-sm font-medium ${notesFilter === "course" ? "bg-[#134e4a] text-white" : "bg-gray-200 text-gray-600"}`}
                    >
                      Course
                    </button>
                  </div>
                    ...
                    filteredNotes.map(note => (
                      <div key={note._id} className="border-b border-gray-200 py-2">
                        <div className="flex justify-between items-start">
                          <div>
                            <p className="text-xs text-gray-500">{new Date(note.createdAt).toLocaleDateString("en-US", { day: "2-digit", month: "2-digit", year: "2-digit" })}</p>
                ...
                <div className="space-y-6">
                  ...
                  {videoError?.lectureId === course.beginnerLectures[currentLectureIndex]._id ? (
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600 mt-1">{watchProgress}% Watched</p>
                    </div>
                  )}
                </div>
              ) : (
            ...
            <div>
              <div className="text-center relative">
                ...
                <div ref={certificateRef} className="bg-white border-2 border-gray-300 rounded-lg p-8 mx-auto max-w-4xl shadow-lg relative">
                  ...
                  <p className="text-base text-gray-600 mb-4">This certificate is proudly presented to</p>
                  <p className="text-3xl font-semibold text-gray-800 mb-6" style={{ fontFamily: "'Dancing Script', cursive" }}>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="text-center">
                      <p className="text-gray-600 mb-2" style={{ fontFamily: "'Dancing Script', cursive", fontSize: "1.25rem" }}>
                        Signature
                      </p>
